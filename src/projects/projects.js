...
let projects = [
  ...
  },
  {
    name: "Mad Libs",
    desc:
      "This is an app created by a teammate and me. It is a copy of a phrasal template word game, Mad Libs, where one player prompts others for a list of words to substitute for blanks in a story.",
...

  {
    ...
    desc:
      "This is a slide the tile and connect the road game made in Java. Implemented a clean user interface using JavaFX. Wrote recursive functions for the detection of level endings.",
