...
const Home = () => {
    let definitions = [  <span className="def fade-in">a full time learner</span>, <span className="def fade-in">free software lover</span>,<span className="def fade-in">infosec newbie</span>, <span className="def fade-in">front end developer</span>, <span className="def fade-in">full stack (stb) developer</span>];
